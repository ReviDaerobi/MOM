...
@section('login')
<div class="h-screen bg-cover bg-center" style="background-image: url('/src/img/studio.jpg');">
    <div class="flex h-full">
        <!-- Left Side -->
        <div class="w-full md:w-1/2 flex items-center justify-center">
            <div class="w-full max-w-md p-8 bg-gradient-to-br from-cardColor via-gray300 to-gray600 rounded-lg shadow-md">
                ...
                <form action="/list-user" method="get">
                    ...
                    <button type="submit" class=" bg-gray600 hover:bg-gray300 text-white font-bold py-2 px-4 w-full rounded focus:outline-none focus:shadow-outline">Login</button>
                    <div class="text-center my-4 text-gray-500">OR</div>
                    <div class="flex justify-between">
                        <button type="button" class="flex items-center justify-center bg-cardColor border border-gray-300 rounded py-2 px-4 w-1/2 mr-2">
                            <img src="/src/img/logo.png" alt="Google" class="w-5 h-5 mr-2">
                            Google
                        </button>
                        <button type="button" class="flex items-center justify-center bg-cardColor border border-gray-300 rounded py-2 px-4 w-1/2 ml-2">
