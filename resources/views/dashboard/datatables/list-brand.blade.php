...
<script  type="text/javascript">
    ...
    var originalData;
        $(document).on('click', '.edit', function(){
            ...
            tr.html(`
                <td><input type="text" id="editbrand_name" value="${data.brand_name}" class="edit-input"></td>
                <td><input type="text" id="editclientid" value="${data.clientid}" class="edit-input"></td>
                <td><input type="text" id="editproduct_code" value="${data.product_code}" class="edit-input"></td>
                <td>
