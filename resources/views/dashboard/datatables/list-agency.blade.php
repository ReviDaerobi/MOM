    ...
    var table = $('#example').DataTable({
     ...
     var originalData;
        $(document).on('click', '.edit', function(){
            ...
            tr.html(`
                <td><input type="text" id="editagencies_name" value="${data.agencies_name}" class="edit-input"></td>
                <td><input type="text" id="editagencies_address" value="${data.agencies_address}" class="edit-input"></td>
                <td><input type="text" id="editnpwp" value="${data.npwp}" class="edit-input"></td>
                <td>
