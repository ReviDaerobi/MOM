...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function(){
            ...
            tr.html(`
                <td><input type="text" id="editversion_name" value="${data.version_name}" class="edit-input"></td>
                <td><input type="text" id="editduration" value="${data.duration}" class="edit-input"></td>
                <td><input type="text" id="edittype_iklan" value="${data.type_iklan}" class="edit-input"></td>
                <td>
